<template>
  <v-container id="alerts" fluid tag="section">
    <view-intro heading="Notifications" link="components/alerts"/>
    <v-row>
      <v-col cols="12" md="6">
        <app-card>
          <v-card-text>
            <div class="text-h5 text--primary">Notification Style</div>
            <material-alert color="info" dark>This is a plain notification.</material-alert>
            <material-alert color="info" dark dismissible>This is a notification with close button.</material-alert>
            <material-alert color="info" dark dismissible icon="mdi-bell">
            ...
            <material-alert color="primary" dark dismissible icon="mdi-bell">
      ...
      <v-col cols="12" md="6">
        <app-card>
          <v-card-text>
            <div class="text-h5 text--primary">Notification States</div>
            <material-alert v-for="color in colors" :key="color" :color="color" dark dismissible>
              <span class="text-uppercase caption font-weight-medium" v-text="color"/>
              — This is a regular alert made with the color of "{{ color }}"
            </material-alert>
            <material-alert color="secondary" dark dismissible>
              <span class="caption font-weight-medium">PRIMARY</span>
              — This is a regular alert made with the color "secondary"
            </material-alert>
            <material-alert color="pink darken-1" dark dismissible>
              <span class="caption font-weight-medium">PINK DARKEN-1</span>
      ...
      <v-col cols="12">
        <app-card>
          <v-card-text class="text-center">
            <div class="text-h5 text--primary">Snackbar Locations</div>
            ...
            <v-row class="mt-n12" justify="center">
              <v-col cols="10" lg="8">
                <v-row class="mt-5">
                  ...
                  <v-col cols="4">
                    <v-btn color="pink darken-1" dark default rounded @click="dialog3 = true">Small Alert Modal</v-btn>
                  </v-col>
                </v-row>
              </v-col>
            </v-row>
    ...
    <material-snackbar v-model="snackbar" :type="color" timeout="-1"
                       v-bind="{
        [parsedDirection[0]]: true,
        [parsedDirection[1]]: true
      }"
    >
      Welcome to <span class="font-weight-bold">&nbsp;MATERIAL DASHBOARD PRO&nbsp;</span> — a beautiful admin panel for
      every web developer.
    </material-snackbar>
      ...
      <v-card>
        ...
        <v-card-text class="body-1 text-center">
          <v-row>
            <v-col cols="12" md="8">
              <div>
                <div><strong>1. Register</strong></div>
                <div class="grey--text">
            ...
            <v-col class="hidden-sm-and-down" md="4">
              <v-sheet>
                <v-img src="https://demos.creative-tim.com/material-dashboard-pro/assets/img/card-1.jpg" height="100"
                       width="200"/>
              </v-sheet>
            </v-col>
            <v-col cols="12" md="8">
              <div>
                <div><strong>2. Apply</strong></div>
                <div class="grey--text">
            ...
            <v-col class="hidden-sm-and-down" md="4">
              <v-sheet>
                <v-img src="https://demos.creative-tim.com/material-dashboard-pro/assets/img/card-2.jpg" height="100"
                       width="200"/>
              </v-sheet>
            </v-col>
