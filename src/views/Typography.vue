        ...
        <material-card color="success" full-header>
          <template #heading>
            <div class="pa-6 white--text">
              <div class="text-h4 font-weight-light">Material Dashboard Heading</div>
              <div class="text-subtitle-1">Created using the Roboto Font Family</div>
            </div>
          </template>
          <v-card-text class="text--primary">
            <v-row v-for="([name, text, component], key, i) in typography" :key="i" align="center">
              <v-col cols="1" md="3" class="caption font-weight-regular text--disabled" v-text="name"/>
              <v-col cols="8">
